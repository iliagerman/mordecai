...
try:
    ...
    print("Install with: uv pip install requests", file=sys.stderr)
...
def extract_report(interaction_data):
    ...
    # Check for 'outputs' array (current API format)
    ...
    # Check for singular 'output' (legacy format)
...
def main():
    ...
    interaction = create_interaction(
        api_key, args.query, output_format=args.format, file_search_store=args.file_search_store
    )
