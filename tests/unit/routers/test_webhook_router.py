...
class TestHandleWebhook:
    ...
    def test_webhook_task_created_success(
    ...
    def test_webhook_external_trigger_success(
        self, client, mock_webhook_service
    ):
    ...
    def test_webhook_service_value_error(self, client, mock_webhook_service):
        ...
        mock_webhook_service.process_event.side_effect = ValueError(
    ...
    def test_webhook_service_exception(self, client, mock_webhook_service):
        ...
        mock_webhook_service.process_event.side_effect = RuntimeError(
            "Unexpected error"
        )
    ...
    def test_webhook_without_optional_source(
        self, client, mock_webhook_service
    ):
